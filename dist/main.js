        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.rest.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/accounts/address')];
                    case 1:
                        data = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        return [4 /*yield*/, this.rest.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/accounts/address', this.currentAddress)];
                    case 2:
                        res = _b.sent();
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_rest_api_service__WEBPACK_IMPORTED_MODULE_7__["RestApiService"], _data_service__WEBPACK_IMPORTED_MODULE_8__["DataService"], _auth_guard_service__WEBPACK_IMPORTED_MODULE_9__["AuthGuardService"]],
            ...
            token: function (stripeToken) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.rest.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/payment', {
...
var MyProductsComponent = /** @class */ (function () {
    function MyProductsComponent(data, rest, changeDetect) {
        this.data = data;
        this.rest = rest;
    ...
    MyProductsComponent.prototype.editProduct = function (e) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data_1 = _a.sent();
                        console.log('filtered ', this.products.filter(function (e) { return e != data_1['products'].id; }));
                        data_1['success'] ? this.products = (this.products.filter(function (e) { return e != (data_1['products'].id); })) : this.data.error(data_1['message']);
                        // data['success'] ? ((this.products.indexOf(data['products'].id) >-1) ? this.products.splice((data['products'].id),1)  : this.products) : this.data.error(data['message']);
    ...
    MyProductsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]])
    ], MyProductsComponent);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.rest.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/seller/products', form)];
                    case 2:
                        data_1 = _a.sent();
                        data_1['success']
